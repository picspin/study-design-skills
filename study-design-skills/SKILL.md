...
description: Use when designing, computing, exporting, reviewing, scoring, or journal-targeting biomedical studies, especially Table 1 baseline characteristics, CSV/XLSX/HTML deliverables, participant flowcharts, observational/RWE causal designs, matching or weighting, diagnostic or prediction studies, AI healthcare workflows, and JCR top-journal benchmark reports.
---
...
Design the study architecture, Table 1, participant flowchart, grouping/matching logic, AI workflow evaluation plan, sensitivity-analysis strategy, and final scoring report as one reporting unit. Align variable blocks, denominators, time zero, exclusions, missingness, statistical comparisons, balance metrics, flowchart nodes, AI-human workflow nodes, sensitivity analyses, footnotes, benchmark scoring, and visual style with the study type, target journal family, and relevant reporting guideline.
...
1. Identify the research design before choosing the table layout.
...
2. Define the table estimand and comparison columns.
...
3. Design the flowchart before finalizing Table 1 denominators.
...
4. Classify variables and summary statistics.
...
5. Specify grouping, matching, weighting, and causal covariate rules.
...
6. Choose inferential and balance columns cautiously.
...
7. Specify missing-data and sensitivity-analysis expectations.
...
9. Produce the scoring report after generating the design artifacts.
...
10. Produce one output or a synchronized package.
...
11. Prefer real files over Markdown-only output when the user requests a deliverable.
...
12. Match journals against the supplied JCR reference set.
